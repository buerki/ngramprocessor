...
Authors of the N-gram Statistics Package (NSP), of which N-Gram Processor is a branch: (v. 1.09) Ted Pedersen, Satanjeev Banerjee, Amruta Purandare, Bridget Thomson-McInnes, Saiyam Kohli; (the v.1.10 re-write) Bjoern Wilmsmann.
